...
class VaultDoctor:
    ...
    async def execute_maintenance_cycle(self):
        ...
        # We delete the old pool and instantly swap in the healthy ones
        ...
        if total_healthy < self.minimum_healthy_ips:
            logging.warning(f"Vault Health Low! Only {total_healthy} IPs remain. Hunter Engine should trigger.")
